...
import { onClickOpenPage, onClickScrollToRef } from "../../../utils/onClick";
  ...
  return (
    <main>
              ...
              <ul>
                <li>
                  ...
                  <div>
                    ...
                    <p>Наша задача не считывать возможности, а создавать их</p>
                  </div>
                </li>
                <li>
                ...
                <li>
                  ...
                  <div>
                    ...
                    <p>
                      Мы акцентируем внимание на эффективном управлении рисками.
                    </p>
                  </div>
                </li>
                <li>
      ...
      <section className={styles.directions}>
        ...
        <img src={directionsPic} alt="directions pic" className={styles.pic} />
      </section>
